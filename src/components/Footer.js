  ...
  return (
    <div> 
           <div className='sm:h-[13vh] h-[10vh] flex flex-row justify-center items-center gap-10 bg-black '>
            <a href='https://linkedin.com/in/junaid-abbas-kaladgi-444a8022b/'><div className=' bg-gray-300 sm:h-[8vh] sm:w-[8vh] h-[6vh] w-[6vh] flex items-center justify-center rounded-full'><AiFillLinkedin size={'5vh'} style={{color:'black',}} /></div></a>
