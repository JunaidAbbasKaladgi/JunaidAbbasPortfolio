...
export const Home = () => {
  ...
  return (
    <div>
      ...
      <Education />
      <div ref={SkillsRef} className=" md:h-[65vh] text-center  p-8 bg-white font-serif py-14   ">
        <p className='font-bold text-3xl'>My Skills</p><br />
        <div className='grid lg:grid-rows-3 sm:grid-rows-5 grid-rows-9 justify-center   sm:gap-x-20 sm:gap-y-8 gap-y-4 grid-flow-col'>
          <Skills name="HTML" percent="90%" />
          <Skills name="React" percent="75%" />
          <Skills name="Django" percent="70%" />
          <Skills name="CSS" percent="90%" />
          <Skills name="Nodejs" percent="60%" />
          <Skills name="MySQL" percent="70%" />
          <Skills name="Javascript" percent="85%" />
          <Skills name="Python" percent="75%" />
      ...
      <div ref={ProjectsRef} className="md:h-[65vh] flex flex-col items-center bg-slate-200 py-5  justify-center  text-center  font-serif ">
        ...
        <div className='flex flex-col gap-4 md:flex-row md:gap-10 justify-center'>
          <Projects name="Ecommerce-FlowerShop(MERN)" image={Ecommerce} url="https://github.com/JunaidAbbasKaladgi/FlowerShop" />
